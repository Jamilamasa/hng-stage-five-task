import { Box, Text, Center, Switch, Button } from "@chakra-ui/react";
  ...
  return (
    ...
    >
      ...
      <Box w={"full"} h={"auto"}>
        ...
        >
          <Box w={"76px"} h={"auto"}>
            <Center w={"auto"} h={"auto"} color={"#928FAB"}>
              <svg
                width="32"
                height="32"
                viewBox="0 0 32 32"
        ...
        <Box
          ...
          px={"16px"}
        >
          <Box alignItems={"center"} w={"full"} display={"flex"}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
